...
<form action="#" class="w-full md:w-1/2 border border-blue-300 p-6 bg-gray-900 backdrop-blur">
...
<div class="w-full pt-3">
    <button type="submit" class="w-full bg-texty text-white bg-opacity-40 border border-blue-300 px-4 py-2 transition duration-50 focus:outline-none font-semibold hover:bg-texty bg-opacity-70 hover:text-white text-xl cursor-pointer">
    Send
    </button>
</div>
</form>
